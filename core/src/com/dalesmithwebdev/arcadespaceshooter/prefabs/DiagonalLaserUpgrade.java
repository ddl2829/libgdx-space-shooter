...
public class DiagonalLaserUpgrade extends Entity {
    public DiagonalLaserUpgrade(float xPos, float yPos) {
        this.add(new RenderComponent(new Texture(Gdx.files.internal("power-ups/pill_green.png")), RenderComponent.PLANE_ABOVE));
        ...
        this.add(new DiagonalLaserUpgradeComponent());
    }
}
