...
public class EnemyLogicSystem extends EntitySystem {
    public void update(float gameTime)
    {
        ...
        {
            PositionComponent pc = ComponentMap.positionMapper.get(enemy);
            SpeedComponent sc = ComponentMap.speedMapper.get(enemy);
            ...
            if(ComponentMap.bossEnemyMapper.has(enemy))
            {
            ...
            PositionComponent playerPosition = ComponentMap.positionMapper.get(players.get(0));//(PositionComponent)players[0].components[typeof(PositionComponent)];
            ...
            EnemyComponent ec = ComponentMap.enemyMapper.get(enemy);
            if(ComponentMap.hasLasersMapper.has(enemy)) {
                HasLasersComponent hasLasersComponent = ComponentMap.hasLasersMapper.get(enemy);
