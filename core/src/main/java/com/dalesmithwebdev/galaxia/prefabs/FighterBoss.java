...
public class FighterBoss extends Entity {
    public FighterBoss(int levelNumber, int yPos) {
        ...
        this.add(new TakesDamageComponent(50 + (10 * levelNumber), DamageTypeConstants.LASER ^ DamageTypeConstants.MISSILE ^ DamageTypeConstants.BOMB));
        this.add(new DealsDamageComponent(50, DamageTypeConstants.ENEMY));
